...
from ShaluS22.callmusic.config import GROUP_SUPPORT as ShaluS22
...
def audio_markup(user_id):
  buttons = [
    [
      InlineKeyboardButton(text="➷ 𝐔𝗽𝗱𝗮𝘁𝗲𝐒 ➹", url=f"https://t.me/ShaluS22"),
      InlineKeyboardButton(text="➹ 𝐒𝘂𝗽𝗽𝗼𝗿𝐓 ➷", url=f"https://t.me/+4fTCw8hKFak2YWU9"),
    ],
    [
      InlineKeyboardButton(text="✯ 𝗢𝘄𝗻𝗲𝗿'𝘅𝗗 ✯", url=f"https://t.me/ShaluS22),
    ],
    [
